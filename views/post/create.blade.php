...
<div class="span9">
    <div class="row-fluid">
        ...
        <div class="span6">
            ...
            {{ Form::open(array('url' => URL::action('PostController@create'),'class'=>'form-horizontal')) }}
                <fieldset>
                    <div id="legend" class="">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="title" placeholder="请写明时间..." class="input-xlarge" type="text" value="{{ date('Y年m月d日工作总结',time())}}">
                        </div>
                    </div>
